...
export SOFTWARE_LIST="$DB1_MASTER;$DB2_MASTER"
export SOFTWARE_LIST="$SOFTWARE_LIST;$BASENV_PKG;$BACKUP_PKG"
export SOFTWARE_LIST="$SOFTWARE_LIST;$DB_BASE_PKG;$DB_PATCH_PKG;$DB_OJVM_PKG;$DB_OPATCH_PKG;$DB_JDKPATCH_PKG;$DB_PERLPATCH_PKG;$BASENV_PKG;$BACKUP_PKG"
export SOFTWARE_LIST="$SOFTWARE_LIST;$CPU_DB_PATCH_PKG;$CPU_DB_OJVM_PKG;$CPU_DB_OPATCH_PKG;$CPU_DB_JDKPATCH_PKG;$CPU_DB_PERLPATCH_PKG;"
