...
module "tvdlab-wls14c" {
  ...
  defined_tags          = local.host_wls14c_defined_tags          # Defined tags to tag the resources created
...
# ------------------------------------------------------------------------------
locals {
  host_wls14c_defined_tags = var.host_wls14c_defined_tags != "" ? var.defined_tags : var.host_wls14c_defined_tags
}
...
variable "host_wls14c_env_config" {
  ...
  default     = "./host_wls12c/set_env_wls14c_config.sh"
  type        = string
}
...
variable "host_wls14c_defined_tags" {
  description = "Defined tags for this resource"
  type        = map(any)
  default     = {}
}

variable "host_wls14c_tags" {
