...
module "tvdlab-db12c" {
  ...
  defined_tags          = local.host_db12c_defined_tags           # Defined tags to tag the resources created
...
# ------------------------------------------------------------------------------
locals {
  host_db12c_defined_tags = var.host_db12c_defined_tags != "" ? var.defined_tags : var.host_db12c_defined_tags
}
...
variable "host_db12c_env_config" {
  ...
  default     = "./host_db12c/set_env_db12c_config.sh"
  type        = string
}
...
variable "host_db12c_defined_tags" {
  description = "Defined tags for this resource"
  type        = map(any)
  default     = {}
}

variable "host_db12c_tags" {
