...
----------------------------------------------------------------------------
--  Name......: 05_config_audit_cdb.sql
--  Author....: Stefan Oehrli (oes) stefan.oehrli@trivadis.com
--  Editor....: Stefan Oehrli
--  Date......: 2021.01.11
--  Usage.....: 
--  Purpose...: Initialize Audit trails CDB
--  Notes.....: 
--  Reference.: 
...
BEGIN
  ...
  SELECT regexp_substr(file_name,'^/.*/') INTO v_datafile_path FROM dba_data_files WHERE file_id=1;
