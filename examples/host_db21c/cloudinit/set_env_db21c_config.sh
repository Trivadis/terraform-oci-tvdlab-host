...
# Date.......: 2021.06.06
# Revision...: 
# Purpose....: Script to config the environement for 21c setup.
# Notes......: --
# Reference..: --
...
# - Customization -------------------------------------------------------------
# Oracle releases
export ORACLE_HOME_NAME="21.0.0.0"              # Oracle Home Name
export ORACLE_EDITION="EE"                      # Oracle edition EE or SE2
export ORACLE_MAJOR_RELEASE="210"               # Oracle major release
...
export DB_BASE_PKG="LINUX.X64_213000_db_home.zip"
export DB_PATCH_PKG=""
export DB_OJVM_PKG=""
export DB_OPATCH_PKG="p6880880_210000_Linux-x86-64.zip"
export DB_JDKPATCH_PKG=""
export DB_PERLPATCH_PKG=""
...
# Source for DB Clone
export DB1_MASTER="master_TCDB210.tgz"          # source for multitenant DB
export DB2_MASTER="master_TCDB210_small.tgz"    # source for multitenant DB
