...
# ------------------------------------------------------------------------------
locals {
  host_oud12c_defined_tags = var.host_oud12c_defined_tags != "" ? var.defined_tags : var.host_oud12c_defined_tags
}
...
variable "host_oud12c_ORACLE_ROOT" {
