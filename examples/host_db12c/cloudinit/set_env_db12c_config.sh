...
# Date.......: 2021.06.06
# Revision...: 
# Purpose....: Script to config the environement for 12c setup.
# Notes......: --
# Reference..: --
...
# - Customization -------------------------------------------------------------
# Oracle releases
export ORACLE_HOME_NAME="12.2.0.1"              # Oracle Home Name
export ORACLE_EDITION="EE"                      # Oracle edition EE or SE2
export ORACLE_MAJOR_RELEASE="122"               # Oracle major release
...
export DB_PATCH_PKG="p32507738_122010_Linux-x86-64.zip"
export DB_OJVM_PKG="p32473172_122010_Linux-x86-64.zip"
export DB_OPATCH_PKG="p6880880_122010_Linux-x86-64.zip"
export DB_JDKPATCH_PKG="p32494298_122010_Linux-x86-64.zip"
export DB_PERLPATCH_PKG="p31858212_122010_Linux-x86-64.zip"
...
# Source for DB Clone
export DB1_MASTER="master_TDB122.tgz"  # source for single tenant DB
export DB2_MASTER="master_TCDB122.tgz" # source for multitenant DB
