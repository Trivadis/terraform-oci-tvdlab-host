...
| `host_shape`                  | The shape of compute instance.                                                                                                                                                  |                       | VM.Standard.E3.Flex              |
...
| `host_env_config`         | Environment script to initiate the compute instance.                                                                                                                                                                    | `set_env_config.template.sh` |         |
