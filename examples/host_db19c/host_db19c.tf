...
module "tvdlab-db19c" {
  ...
  host_ORACLE_DATA      = var.host_db19c_ORACLE_DATA              # default Oracle data folder used to store datafiles
  host_ORACLE_ARCH      = var.host_db19c_ORACLE_ARCH              # default Oracle arch folder used to store archive logs and backups
