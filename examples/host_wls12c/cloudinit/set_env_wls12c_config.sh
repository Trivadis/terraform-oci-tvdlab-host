...
# ------------------------------------------------------------------------------
# Name.......: set_env_wls12c_config.sh
# Author.....: Stefan Oehrli (oes) stefan.oehrli@trivadis.com
# Editor.....: Stefan Oehrli
# Date.......: 2021.06.11
# Revision...: 
# Purpose....: Script to config the environement for WLS 12c setup.
# Notes......: --
# Reference..: --
...
# - Customization --------------------------------------------------------------
# Oracle releases
export WLS_HOME_NAME="wls12.2.1.4.0"            # Oracle Home Name
export BE_ALIAS="wls12214"                      # BasEnv Alias name
...
export FMW_PATCH_PKG="p32253037_122140_Generic.zip"
export COHERENCE_PATCH_PKG="p32124456_122140_Generic.zip"
export WLS_ONEOFF_PKGS="p32097167_12214201001_Generic.zip"
...
export CPU_FMW_PATCH_PKG="p32698246_122140_Generic.zip"
export CPU_COHERENCE_PATCH_PKG="p32581859_122140_Generic.zip"
